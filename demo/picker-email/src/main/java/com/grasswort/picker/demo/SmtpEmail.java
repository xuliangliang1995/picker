...
public class SmtpEmail {
    ...
    public static void main(String[] args) {
        ...
        props.put("mail.user", "xuliangliang@notice.grasswort.com");
        // 访问SMTP服务时需要提供的密码(在控制台选择发信地址进行设置)
        props.put("mail.password", "GrassworT19950422");
...
//        mailSession.setDebug(true);
        ...
        try {
            ...
            InternetAddress from = new InternetAddress("xuliangliang@notice.grasswort.com", "Picker");
            message.setFrom(from);
            //可选。设置回信地址
            Address[] a = new Address[1];
            a[0] = new InternetAddress("835547206@qq.com");
            message.setReplyTo(a);
            // 设置收件人邮件地址，比如yyy@yyy.com
            InternetAddress to = new InternetAddress("835547206@qq.com");
