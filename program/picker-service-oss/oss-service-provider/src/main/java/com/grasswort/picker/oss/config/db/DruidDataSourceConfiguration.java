package com.grasswort.picker.oss.config.db;
...
public class DruidDataSourceConfiguration {
    private final static String MAPPER_XML_LOCATION = "classpath:com.grasswort.picker.oss.dao.persistence.*Mapper.xml";
